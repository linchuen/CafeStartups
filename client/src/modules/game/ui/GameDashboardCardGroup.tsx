...
export function GameDashboardCardGroup({ title, subtitle, cards, selectedId, onSelect }: { title: string; subtitle: string; cards: PlayerCard[]; selectedId?: string; onSelect?: (id: string) => void }) {
