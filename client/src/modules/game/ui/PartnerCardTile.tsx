...
const partnerMeta: Record<string, { icon: string; role: string }> = {
  'partner-barista': { icon: 'operations', role: '咖啡師・營運專業' },
  'partner-roaster': { icon: 'coffee', role: '烘豆師・產品專業' },
  'partner-marketer': { icon: 'marketing', role: '行銷師・品牌專業' },
  'partner-service': { icon: 'people', role: '服務設計・體驗專業' },
  'partner-finance': { icon: 'people', role: '財務管理・資金專業' },
  'partner-pastry': { icon: 'coffee', role: '甜點開發・產品專業' },
  'partner-supply': { icon: 'people', role: '供應鏈管理・採購專業' },
  'partner-community': { icon: 'people', role: '社區合作・通路專業' },
  'partner-hr': { icon: 'people', role: '人才培訓・服務專業' },
  'partner-analytics': { icon: 'marketing', role: '數據營運・通路專業' },
}
