...
function HandActionBar({ room, selected, command, busy, showLoan = true, showCardActions = true }: { room: DashboardRoom; selected?: PlayerCard; command: (type: string, extra?: Record<string, unknown>) => void; busy: boolean; showLoan?: boolean; showCardActions?: boolean }) {
