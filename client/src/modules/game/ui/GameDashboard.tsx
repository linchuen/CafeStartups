...
import { Alert, Box, Button, Card as MuiCard, CardContent, Chip, Container, Divider, Grid, Paper, Stack, Toolbar, Typography } from '@mui/material'
...
type DashboardRoom = { period: number; round: number; phase: string; players: DashboardPlayer[]; demandBoard?: Record<string, number>; me?: { id: string; hand: PlayerCard[]; tableau: PlayerCard[]; partner?: PlayerCard; starterShop?: PlayerCard; cash: number; loans: number; revenue?: number; score?: number; brandAwareness?: number; products?: number; values?: number; resources?: number } }
