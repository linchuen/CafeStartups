...
type Player = { id: string; displayName: string; bot?: boolean; ready: boolean; cash: number; loans: number; revenue?: number; score?: number; handCount: number }
type GameState = { id: string; roomCode: string; status: string; seed: string; gameVersion: number; period: number; phase: string; round: number; players: Player[]; me?: { id: string; hand: Card[]; tableau: Card[]; discardCount: number; cash: number; loans: number; customers?: { kind: string; demand: string; unitPrice: number; count: number }[]; revenue?: number; score?: number } }
