...
const REFERENCE_PERIODS = [
  { id: 1, gourmet: '+10', regular: '+10', customers: [3, 2, 1, 1] },
  { id: 2, gourmet: '+20', regular: '+10', customers: [4, 3, 2, 1] },
  { id: 3, gourmet: '+30', regular: '+10', customers: [5, 3, 2, 1] },
]
  ...
  return <details className="reference-panel" open>
    ...
    <div className="reference-board" aria-label="玩家規則參考面板">
      ...
      <div className="reference-rules">
        ...
        <div className="reference-period-head"><span className="reference-customer-spacer">客群需求與來客</span><span className="reference-initial">0<small>回合</small></span>{REFERENCE_PERIODS.map((item) => <span className={props.period === item.id ? 'is-current' : ''} key={item.id}>{item.id}<small>回合</small></span>)}</div>
